...
public class ForgetPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtMode = (EditText) findViewById(R.id.editTxtForgotPassword);
        txtMode = (TextView) findViewById(R.id.textView);
        submit = (Button) findViewById(R.id.submit);
        labelMode = (TextInputLayout) findViewById(R.id.textInputLayout);
